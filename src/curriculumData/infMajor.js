module.exports = {
  ...
  "POLSC 120": {
    title: "Comparative Gov/Politics",
    description:
      "An introduction to the development of political institutions and the distribution and exercise of political power in selected western, communist and Third World countries. Special attention will be devoted to the impact of institutional and cultural patterns upon the quality of life in those countries.",
    distributionRequirements: ["IP", "CL"],
    credits: "4",
    prerequisites: {
      anyof: [],
      allof: [],
  ...
  "POLSC 215": {
    title: "Politics in Popular Culture",
    description:
  ...
  "POLSC 424": {
    title: "Inequality and Social Policy",
    description:
    ...
    distributionRequirements: ["IP", "PD"],
    credits: "4",
    prerequisites: {
      anyof: [],
      allof: [],
