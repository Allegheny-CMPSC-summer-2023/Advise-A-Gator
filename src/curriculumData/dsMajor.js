module.exports = {
  ...
  "CMPSC 301": {
    ...
    distributionRequirements: ["QR", "PD"],
    credits: "4",
    prerequisites: {
    ...
    unlocks: ["CMPSC 405"],
    topics: ["Statistical Analysis", "Plotting", "Ethics"],
    technicalTopics: [],
    professionalTopics: [],
    tools: [
      {
  ...
  "PHIL 210 ": {
    ...
    distributionRequirements: ["CL", "PD"],
    credits: "4",
    prerequisites: {
      anyof: [],
      allof: [],
  ...
  "ENGL 210": {
    ...
    prerequisites: {
      anyof: [],
      allof: ["One 100-level literature course"],
    },
    unlocks: [],
    topics: [],
    technicalTopics: [],
  ...
  "MATH 345": {
    ...
    distributionRequirements: ["SP"],
    credits: "4",
    prerequisites: {
      anyof: ["MATH 152", "MATH 210"],
      allof: [],
    },
    unlocks: ["MATH 346"],
    topics: [],
  ...
  "MATH 320": {
    ...
    description:
      "A study of vector spaces, linear transformations, matrices, determinants, systems of linear equations, similarity, and characteristic values and vectors. This course may be applied toward the mathematics requirement for a Computer Science major. This course is one of the possible mathematics courses that may be substituted for one of the required 300-level CMPSC courses in the Computer Science major.",
    distributionRequirements: ["SP"],
    credits: "4",
    prerequisites: {
      anyof: ["MATH 205", "MATH 210", "MATH 211", "MATH 270", "MATH 280"],
      allof: [],
    },
    unlocks: [],
    topics: [],
  ...
  "DS 610 ": {
    ...
    prerequisites: {
      anyof: ["DS 600"],
      allof: ["Permission of the instructor"],
    },
    unlocks: [],
    topics: [
      "Planning",
  ...
  "COMM 360": {
    ...
    description:
      "An exploration of the ways communication enhances civic engagement in an ever-changing society. Students critically engage with models of civic engagement to better understand how they legitimize forms of communicative interaction, authorize who can and cannot speak, and set standards for what can be said and how. Students consider how they can affect change in their own communities and/or personal lives.",
    distributionRequirements: ["HE", "CL"],
    credits: "4",
    prerequisites: {
      anyof: ["COMM 120", "COMM 145"],
      allof: ["COMM 256", "Permission of the instructor"],
    },
    unlocks: [],
    topics: [],
    technicalTopics: [],
  ...
  "BIO 321": {
    ...
    credits: "4",
    prerequisites: {
      anyof: ["BIO 219", "BIO 220"],
      allof: ["BIO 221", "FSBIO 201"],
    },
    unlocks: [],
    topics: [],
    technicalTopics: [],
