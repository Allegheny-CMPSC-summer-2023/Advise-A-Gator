...
import SoftwareEngineeringMajorBlock from "../components/Roadmap/components/SoftwareEngineeringMajorBlock";
...
const SoftwareEngineeringMajorContainer = () => {
  return (
    <div className={classes["main-container"]}>
      <svg
        ...
        xmlns="http://www.w3.org/2000/svg"
      >
        <SoftwareEngineeringMajorBlock boxData={boxesData["seMajor"]} />
        {/* <Lines /> */}
      </svg>
    </div>
  );
...
function SoftwareEngineeringMajor() {
  ...
  return (
    <div>
      ...
      <main>
        {isLoading && <Loader />}
        <SoftwareEngineeringMajorContainer />
      </main>
      <Footer></Footer>
    </div>
  );
...
export default SoftwareEngineeringMajor;
